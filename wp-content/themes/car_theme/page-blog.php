							...
							<div class="blog-item__content">
								<div class="blog-item__info">
									<a href="" class="blog-item__title line-2">
										<h3 class="line-2"> Báo chí đưa tin về sự kiện ký kết Biên bản dax them line-2
										</h3>
									</a>
									<div class="blog-item__meta">
										<div class="blog-item__category">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
												...
												<path d="M13.6668 11.1H10.3335" stroke="#354764" stroke-miterlimit="10"
										...
										<div class="blog-item__date">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
												...
												<path d="M14.6665 5.33331V7.33331" stroke="#354764"
													stroke-miterlimit="10" stroke-linecap="round"
													stroke-linejoin="round" />
												<path d="M6.3335 10.06H17.6668" stroke="#354764" stroke-miterlimit="10"
													stroke-linecap="round" stroke-linejoin="round" />
												<path
													...
													stroke-linejoin="round" />
												<path d="M14.463 13.1333H14.469" stroke="#354764" stroke-linecap="round"
													stroke-linejoin="round" />
												<path d="M14.463 15.1333H14.469" stroke="#354764" stroke-linecap="round"
													stroke-linejoin="round" />
			...
			<div class="col-lg-4">
				<div class="news-item">
					<div class="news-item__image">
						<img src="car-thumbnail.jpg" alt="Porsche và Subaru có dịch vụ khách hàng tốt nhất">
					</div>
					<div class="news-item__content">
						<h3 class="news-item__title">Porsche và Subaru có dịch vụ khách hàng tốt nhất</h3>
						<div class="news-item__meta">
							<span class="news-item__category">
								<img src="icon-category.svg" alt="icon"> Xe hay
							</span>
							<span class="news-item__date">
								<img src="icon-calendar.svg" alt="icon"> 16/3/2025
							</span>
						</div>
						<a href="#" class="news-item__button">Xem ngay</a>
					</div>
				</div>
			</div>
		</div>
