...
<section class="search__secSpace">
    <div class="container">
        ...
        <div class="search__header">
            <h1 class="search__title">Tin tức</h1>
            ...
            <div class="row search-news__gap">
                <?php for ($i = 0; $i < 5; $i++): ?>
                    <div class="search-news-item">
                        <div class="row">
                            <div class="col-2">
                                <a href="#" class="search-news-item__image">
                            ...
                            <div class="col-10">
                                <div class="search-news-item__content">
                                    <a href="" class="search-news-item__title">
                                        <h3 class="line-1"> Báo chí đưa tin về sự kiện ký kết Biên bản dax them
                                            line-2 line-2"> Báo chí đưa tin về sự kiện ký kết Biên bản dax them
                                            line-2
                                        </h3>
                                    </a>
        ...
        <!-- Pagination -->
        <?php
        echo '<div class="pagination pagination--custom">';
        echo paginate_links(
            array(
                'total' => 5,
                'current' => max(1, 5),
