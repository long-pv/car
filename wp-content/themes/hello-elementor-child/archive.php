...
<div class="secSpace">
	<div class="news-banner"
		style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/images/Banner-news.png');">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-10">
					...
					<p class="news-banner__desc">
						Nền tảng công nghệ dành cho ngành công nghiệp xe hơi hàng đầu Việt Nam
					</p>
				</div>
			</div>
		</div>
...
<div class="container">
	<div class="secSpace">
		...
		$category_id = $current_category->term_id; // Lấy ID của danh mục
			...
			<section class="secSpace">
				<div class="container">
					<div class="row g-4">
											...
											<div class="blog-item__content">
												<div class="blog-item__info">
													<a href="" class="blog-item__title line-2">
														<h3 class="line-2"> Báo chí đưa tin về sự kiện ký kết Biên bản dax
															them
															line-2
														</h3>
													</a>
						...
						Porsche và Subaru có dịch vụ khách hàng tốt nhất">
										<div class="related-news__content">
											<h3 class="related-news__title">Porsche và Subaru có dịch vụ khách hàng tốt nhất
											</h3>
											<div class="related-news__info">
												<div class="related-news__meta">
													<div class="related-news__category">
